...
func RegisterBusinessHTTPServer(s *http.Server, srv BusinessHTTPServer) {
	...
	r.POST("/b/v1/review/appeal", _Business_AppealReview1_HTTP_Handler(srv))
}
...
func _Business_AppealReview1_HTTP_Handler(srv BusinessHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
