...
func RegisterOperationHTTPServer(s *http.Server, srv OperationHTTPServer) {
	r := s.Route("/")
	r.POST("/o/v1/review/audit", _Operation_AuditReview1_HTTP_Handler(srv))
	r.POST("/o/v1/appeal/audit", _Operation_AuditAppeal1_HTTP_Handler(srv))
}

func _Operation_AuditReview1_HTTP_Handler(srv OperationHTTPServer) func(ctx http.Context) error {
...
func _Operation_AuditAppeal1_HTTP_Handler(srv OperationHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
